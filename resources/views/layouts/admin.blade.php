...
<head>
    ...
    <title>Pendafatarn Online - SMAN 1 Gunung Putri</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Admin - Pendaftaran Online</div>
            </a>
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item {{ Nav::isRoute('data-pendaftaran') }}">
                <a class="nav-link" href="{{ route('data-pendaftaran') }}">
